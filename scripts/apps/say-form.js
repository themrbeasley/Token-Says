 ...
 */
export class TokenSaysSayForm extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    _onRender(context, options) {
        ...
        // --- Event listeners (replacing activateListeners) ---
    ...
    static async _onSubmit(event, form, formData) {
        // `this` is bound to the TokenSaysSayForm instance by ApplicationV2
